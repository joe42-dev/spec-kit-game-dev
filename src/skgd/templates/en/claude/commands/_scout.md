...
| `/implement` | config, state, tasks, plan, learnings | Engine, session, remaining tasks, patterns |
...
Task:
  ...
  prompt: |
    ...
    1. `.skgd/config.yaml` - extract engine (unity/godot) and language
    2. `.skgd/state.yaml` - extract current_spec, checkpoint, tasks_completed
    3. `docs/specs/[current_spec]/tasks.md` - count total, list UNCHECKED [ ] only
    4. `docs/specs/[current_spec]/plan.md` - identify current phase
    5. `.skgd/memory/learnings-core.md` - extract 3-5 relevant patterns
    ...
    **Engine:** [unity|godot]
    **Feature:** [name]
    **Session:** [new | resume from T0XX]
    **Tasks:** Total: [N] | Done: [X] | Remaining: [N-X]
