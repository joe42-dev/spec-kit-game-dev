...
**Goal:** Ensure all required assets exist before code implementation
**Estimated Complexity:** Varies

> This phase runs BEFORE code implementation.
> Use /assets generate [feature] or create placeholders.

#### Asset Checklist (from spec)
| Asset | Type | Status | MCP | Notes |
|-------|------|--------|-----|-------|
| [asset_name] | sprite | pending | pixellab | [notes] |
| [asset_name] | model | pending | blender | [notes] |
| [asset_name] | sfx | pending | manual | [notes] |

#### Asset Generation Commands
```yaml
# Option A: Generate via PixelLab MCP (2D sprites)
# [Commands will be added by /assets generate]

# Option B: Generate via Blender MCP (3D models)
# [Commands will be added by /assets generate]

# Option C: Create placeholders
mcp__UnityMCP__manage_asset:
  action: create
  asset_type: "Texture2D"
  path: "Assets/Art/Sprites/placeholder_[name].png"
  properties:
    width: 32
    height: 32
    color: "#FF6B6B"  # Placeholder color
```

#### Asset Import (after generation)
```yaml
# Import generated assets to Unity
mcp__UnityMCP__manage_asset:
  action: import
  path: "Assets/Art/Sprites/[generated_file]"
```

#### Verification
- [ ] All required assets exist in project
