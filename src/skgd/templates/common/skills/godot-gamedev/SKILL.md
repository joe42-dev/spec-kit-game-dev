---
name: godot-gamedev
description: Godot game development patterns and GDAI MCP tool usage. Provides GDScript templates, node management, scene structure, and signal patterns. Use when working with Godot, creating GDScript files, managing nodes, scenes, or debugging Godot projects.
---
