...
## Table of Contents
- [Creating Scripts](#creating-scripts) - create_script, Basic templates, class_name
- [Script Structure](#script-structure) - Standard template with signals, exports, lifecycle
- [Attaching Scripts](#attaching-scripts) - attach_script to existing nodes
- [Export Patterns](#export-patterns) - @export, ranges, enums, resources, nodes
- [Common Patterns](#common-patterns) - State machine, Singleton/Autoload, Resources
- [Error Checking](#error-checking) - get_godot_errors, Common issues
