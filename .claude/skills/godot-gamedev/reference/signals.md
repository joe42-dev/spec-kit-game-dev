...
## Table of Contents
- [Signal Basics](#signal-basics) - Declaring, Emitting, Connecting signals
- [Common Signal Patterns](#common-signal-patterns) - Health system, State machine, UI binding, Event bus
- [Built-in Signals](#built-in-signals) - Area2D, Button, Timer, AnimationPlayer
- [Connection Patterns](#connection-patterns) - Dynamic connections, Disconnecting, Lambdas
- [Signal vs Direct Call](#signal-vs-direct-call) - When to use each approach
