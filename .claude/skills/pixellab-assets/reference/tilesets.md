...
## Table of Contents
- [Tileset Types Overview](#tileset-types-overview) - Top-Down, Sidescroller, Isometric comparison
- [Top-Down Tilesets (Wang)](#top-down-tilesets-wang) - Wang tiles, Terrain chaining pattern
- [Sidescroller Tilesets](#sidescroller-tilesets) - Platform types, Transparent backgrounds
- [Isometric Tiles](#isometric-tiles) - Tile shapes, Consistent sets
- [Transition Size Guide](#transition-size-guide) - Sharp to wide gradients
- [Tileset Workflow](#tileset-workflow) - Complete map tileset pipeline
