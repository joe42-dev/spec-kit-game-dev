...
## Table of Contents
- [Creating GameObjects](#creating-gameobjects) - Empty, Primitive, With Parent
- [Adding Components](#adding-components) - Single, Multiple at creation
- [Configuring Components](#configuring-components) - set_component_property patterns
- [Finding GameObjects](#finding-gameobjects) - By name, tag, component
- [Modifying GameObjects](#modifying-gameobjects) - Transform, Active state, Tags/Layers
- [Getting Component Info](#getting-component-info) - Inspect existing objects
- [Hierarchy Patterns](#hierarchy-patterns) - Standard Player/Enemy setups
