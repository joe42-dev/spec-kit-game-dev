...
> **Token estimate:** ~500 tokens | **Last updated:** 2025-12

## Table of Contents
- [Running Tests](#running-tests) - EditMode, PlayMode, Timeout
- [Console Monitoring](#console-monitoring) - Errors, Warnings, Stacktrace, Clear
- [Editor Play Control](#editor-play-control) - Play, Pause, Stop, Get state
- [Test-Implement Cycle](#test-implement-cycle) - Validation flow, Quick play test
- [Writing Test Scripts](#writing-test-scripts) - EditMode/PlayMode templates
- [Test Organization](#test-organization) - Folder structure, Assembly definitions
- [Debugging Patterns](#debugging-patterns) - Error analysis, Runtime state
