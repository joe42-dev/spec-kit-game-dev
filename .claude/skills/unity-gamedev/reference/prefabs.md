...
## Table of Contents
- [Creating Prefabs](#creating-prefabs) - From GameObject, With overwrite protection
- [Instantiating Prefabs](#instantiating-prefabs) - Single and multiple instances
- [Modifying Prefabs](#modifying-prefabs) - Edit asset, Get components
- [Prefab Organization](#prefab-organization) - Recommended folder structure
- [Prefab Variants Pattern](#prefab-variants-pattern) - Base and variant workflow
- [Complete Workflow Example](#complete-workflow-example) - Full Player prefab creation
