# /brainstorm - Creative Game Design Session
...
**IF game-brief does NOT exist → Offer MODE SELECTION**
**IF game-brief EXISTS → SPARK MODE** (creative injection)

---

## Step 2: Mode Selection (No game-brief)
