...
**BEFORE any other step**, gather context via Scout sub-agent:
...
- prompt: |
    ...
    3. Read docs/pillars/[pillar-name].md - get stub content and questions
    4. Read docs/game-brief.md - extract core vision (3-5 bullet points)
    5. Read .skgd/memory/constitution.md - extract design principles (if exists)
    6. Identify potential cross-pillar tensions or dependencies
    ...
    **Vision Summary:** [3-5 bullets from game-brief]
    **Design Principles:** [from constitution or "not defined yet"]
    **Completed Pillar Decisions:**
    - [pillar-1]: [key decision]
    - [pillar-2]: [key decision]
    **Target Pillar Questions:** [questions from stub]
    **Potential Tensions:** [cross-pillar issues or "none identified"]
    **Missing:** [files not found or "none"]

**IF Scout returns status "blocked":** Stop and inform user what's missing.
**IF Scout returns status "partial":** Proceed with warnings about missing context.
...
Use the Scout Report from Phase 0 as your primary context.

**The Scout Report contains:**
- Vision summary (from game-brief.md)
- Design principles (from constitution.md)
- Pillar progress and completed decisions
- Target pillar questions
- Cross-pillar tensions

**Only read additional files if:**
- Scout Report status is "partial" or "blocked"
- User asks about specific details not in report
- Deep clarification needed on a particular decision

**Context budget:** Scout Report (~500 tokens) + minimal targeted reads if needed.
